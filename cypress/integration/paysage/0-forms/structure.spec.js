context('Structure form page', () => {
    ...
    it('should switch toggle value', () => {
        ...
        cy.get('[data-cy="create/structure@etat#0/test#0"]')
            .find('input')
            .should('be.checked');
    ...
    it('should clean new Toggle', () => {
        ...
        cy.get('[data-cy="create/structure@etat#1/test#0"]').should(
            'not.exist'
        );
    });
    ...
    it('should select catégorie 2 Type value', () => {
        cy.get('[data-testid="create/structure@categories#0/type#0"]')
            .find('select')
            .select('catégorie 2');
        cy.get('[data-testid="create/structure@categories#0/type#0"]')
            .find('select')
