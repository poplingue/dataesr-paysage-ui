...
describe('TileElement component', () => {
    ...
    beforeEach(() => {
        ...
        wrapper = (context = {}, props) => render(
            <TileElement title={props.title}
    ...
    it('renders correctly TileElement with exportMode', () => {
        const component = wrapper({ stateList: { exportMode: true } }, { title: 'Title 1', checked: true });
        expect(component).toMatchSnapshot();
    });

    it('should display Texts', () => {
        wrapper({ stateList: { exportMode: true } }, {
            title: 'Title 1',
            body: 'Bobody',
            subTitle: 'subTitle',
            checked: true
