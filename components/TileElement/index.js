...
export default function TileElement({ color, title, subTitle, body, onClick, id, checked, defaultIcon }) {
                ...
                <Container fluid className="w-100">
                    <Row alignItems="top">
                        ...
                        <Col n="1" className="txt-right">
                            {!exportMode && defaultIcon && <Icon name={defaultIcon} size="2x" color={color}/>}
                            {exportMode && <>
                                {checked ?
                                    <Icon name="ri-checkbox-line" size="2x" color={color}/> :
                                    <Icon name="ri-checkbox-blank-line" size="2x" color={color}/>}</>}
                        </Col>
                    </Row>
                </Container>
            </TileBody>
